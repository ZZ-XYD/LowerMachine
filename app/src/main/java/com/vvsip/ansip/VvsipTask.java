...
public class VvsipTask {
	...
	public native int vvsessionstartwithaudio(String identity, String target, String proxy, String outboundproxy);
	...
	public native int vvreceivedtmf(int received);
	...
	private void vvsipLoop() {
		...
		while (running==true) {
			...
			if (evt!=0)
			{
				...
				Message m = Message.obtain(); //new Message();d
				m.what = type;
